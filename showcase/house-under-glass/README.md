...
This directory is currently a first playable slice of the planned showcase. See [PLAN.md](PLAN.md) for the intended full story shape, room list, puzzle chain, and engine features the showcase should exercise.
